...
export default function EditWeddingClient() {
      ...
      {loading ? (
        ...
        <div className="bg-black p-6 text-center text-white relative">
            {typeof window !== 'undefined' && !(window.matchMedia("(display-mode: standalone)").matches || (window.navigator as any).standalone) && (
              <Link 
                href="/admin" 
                className="absolute left-6 top-1/2 -translate-y-1/2 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-white transition-colors group"
              >
