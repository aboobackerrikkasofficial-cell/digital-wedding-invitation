...
export default function TrackingClient() {
  ...
  useEffect(() => {
    // Lock scrolling on this specific page to fit in one single page
    // Using 100dvh to handle mobile browser toolbars correctly
  ...
  return (
    <div className="flex-1 min-h-0 bg-gray-50 overflow-hidden flex flex-col">
      {loading ? (
        ...
        >
          {!wedding ? (
            ...
            <div className="h-full bg-[#fafafa] flex flex-col overflow-hidden p-4 lg:pt-0 lg:px-0 lg:pb-8">
