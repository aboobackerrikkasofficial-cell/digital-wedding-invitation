...
export function MobileElegantIslamicTemplate({ wedding, onAttend, onNotAttend }: ElegantTemplateProps) {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#fdfbf0] overflow-y-auto overflow-x-hidden flex flex-col items-center pt-10 px-4 pb-10 cream-gold-theme">
      ...
      <div className="relative z-10 flex flex-col gap-8 w-full max-w-md">
        <main className="relative w-full aspect-[9/16] border-[1px] border-[#c5a059]/30 bg-white shadow-2xl rounded-[1.5rem] overflow-hidden px-8 py-10 text-center flex flex-col items-center justify-center">
