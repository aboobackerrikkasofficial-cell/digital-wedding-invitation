...
export function WebInvitationLanding({ wedding, onAttend, onNotAttend }: InvitationLandingProps) {
  ...
  return (
    <div className="relative min-h-[100dvh] lg:h-[100dvh] w-full bg-[#fdfbf0] overflow-hidden flex items-center justify-center md:justify-start font-sans selection:bg-gold/30">
      ...
      <main className="relative z-10 w-full max-w-2xl px-[6px] md:px-0 md:ml-32 h-full flex flex-col justify-center">
        <motion.div
