    ...
    <div className="web-template-container left-0 right-0 z-40 w-full bg-[#fffcf2] font-serif p-0 lg:p-8 cream-gold-theme relative lg:fixed top-0 min-h-screen lg:h-screen overflow-y-auto lg:overflow-hidden flex flex-col lg:flex-row items-center justify-start lg:justify-center px-[5px] lg:px-8">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row gap-6 lg:gap-[60px] items-center justify-center w-full max-w-6xl h-fit">
        <motion.main 
          ...
          className="relative w-full max-w-[420px] lg:max-w-lg h-auto min-h-[680px] lg:h-[715px] flex flex-col justify-between text-center border-[1px] border-[#c5a059]/30 rounded-[1.8rem] lg:rounded-[2.2rem] bg-white shadow-[0_20px_40px_rgba(197,160,89,0.1)] overflow-hidden mt-[20px] lg:mt-0">
          ...
          <motion.div variants={{ hidden: { opacity: 0 }, show: { opacity: 1, transition: { staggerChildren: 0.3, delayChildren: 0.6 } } }} initial="hidden" animate="show" className="relative z-10 w-full flex-grow flex flex-col items-center justify-start text-center mt-[232px] lg:mt-[250px] px-6 lg:px-10 pb-[70px] lg:pb-[10px] overflow-hidden no-scrollbar" style={{ willChange: "transform, opacity" }}>
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }} className="flex flex-col items-center mb-6">
              ...
              <p className="text-gold-muted font-poppins text-[7.5px] lg:text-[9px] uppercase tracking-[0.05em] [word-spacing:0.1em] font-bold mt-[-8px] whitespace-nowrap">{wedding.host_selection === 'bride_side' ? wedding.bride_place : wedding.groom_place}</p>
            </motion.div>
            <motion.p variants={{ hidden: { opacity: 0 }, show: { opacity: 1 } }} className="text-gold-primary font-poppins text-[7.5px] lg:text-[9px] tracking-[0.05em] [word-spacing:0.1em] font-medium uppercase mt-[-14px] mb-[10px] flex flex-col items-center gap-0 leading-none"><span>REQUEST THE PLEASURE OF YOUR COMPANY AT THE WEDDING CEREMONY</span><span>OF OUR BELOVED {wedding.host_selection === 'bride_side' ? 'DAUGHTER' : 'SON'}</span></motion.p>
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex flex-col items-center mb-[13px]">
              ...
              <p className="text-gold-muted font-poppins text-[7.5px] lg:text-[9px] uppercase tracking-[0.05em] [word-spacing:0.1em] font-bold mt-[-8px] whitespace-nowrap">{wedding.host_selection === 'bride_side' ? wedding.groom_place : wedding.bride_place}</p>
            </motion.div>
