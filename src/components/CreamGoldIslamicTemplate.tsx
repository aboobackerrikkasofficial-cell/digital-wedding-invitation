...
export function CreamGoldIslamicTemplate({ wedding, onAttend, onNotAttend }: TemplateProps) {
  ...
  return (
    <div className="relative h-full lg:h-[calc(100dvh-2rem)] w-full bg-[#fffcf2] overflow-hidden flex items-center justify-center font-serif p-4 lg:p-10 cream-gold-theme">
      <BackgroundDecor />
      ...
      <div className="relative z-10 flex flex-col lg:flex-row gap-6 lg:gap-[60px] items-center justify-center w-full max-w-6xl h-full py-4">
        ...
        <main className="relative w-full max-w-[420px] lg:max-w-lg h-full max-h-[715px] flex flex-col justify-between text-center border-[1px] border-[#c5a059]/30 rounded-[1.8rem] lg:rounded-[2.2rem] bg-white shadow-[0_20px_40px_rgba(197,160,89,0.1)] overflow-hidden flex-shrink">
        ...
        <aside className="relative w-full max-w-[420px] lg:max-w-lg h-fit lg:h-full lg:max-h-[715px] flex flex-col items-center justify-between p-0 lg:py-[20px] lg:px-10 text-center rounded-none lg:rounded-[2.2rem] bg-transparent lg:bg-white lg:shadow-[0_20px_50px_rgba(197,160,89,0.1)] overflow-visible gap-5 lg:gap-0 border-none lg:border-[1px] border-[#c5a059]/20 flex-shrink">
