  ...
  return (
    <div className="relative min-h-[100dvh] lg:h-[100dvh] w-full bg-[#fffcf2] overflow-y-auto lg:overflow-hidden flex items-center justify-center font-serif pt-6 px-4 pb-2 md:p-6 lg:pt-[50px] lg:pb-[50px] lg:px-10 cream-gold-theme">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row gap-6 lg:gap-[60px] items-center justify-center w-full max-w-6xl h-full">
        ...
        <main className="relative w-full max-w-[420px] lg:max-w-lg h-[712px] lg:h-[715px] flex flex-col justify-between text-center border-[1px] border-[#c5a059]/30 rounded-none bg-white shadow-[0_20px_40px_rgba(197,160,89,0.1)] overflow-hidden">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className="relative z-10 w-full flex-grow flex flex-col items-center justify-start text-center mt-[220px] lg:mt-[250px] px-6 lg:px-10 pb-[70px] lg:pb-[10px] overflow-hidden no-scrollbar"
            style={{ willChange: "transform, opacity" }}
          >
            {/* A. BISMILLAH LINE */}
            <motion.p
              variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }}
              className="text-gold-primary font-poppins text-[8px] lg:text-[9px] tracking-[0.05em] [word-spacing:0.1em] font-normal uppercase mt-[30px] lg:mt-[10px] mb-[12px] whitespace-nowrap in-the-name-of-allah"
            >
        ...
        <aside className="relative w-full max-w-[420px] lg:max-w-lg h-fit lg:h-[715px] flex flex-col items-center justify-between p-0 lg:py-[20px] lg:px-10 text-center rounded-none bg-transparent lg:bg-white lg:shadow-[0_20px_50px_rgba(197,160,89,0.1)] overflow-visible gap-5 lg:gap-0 border-none lg:border-[1px] border-[#c5a059]/20">
          
          {/* Countdown */}
          <div className="w-full p-8 lg:p-0 border-[1px] lg:border-none border-gold-muted/30 rounded-none bg-white lg:bg-transparent shadow-xl lg:shadow-none">
            <motion.div
          ...
          {/* RSVP */}
          <div className="w-full p-8 lg:p-0 border-[1px] lg:border-none border-[#c5a059]/20 rounded-none bg-white lg:bg-transparent shadow-xl lg:shadow-none">
            <motion.h3
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
